...
function init() {
  ...
  spawn('mpv', ['--af=loudnorm=I=-14:LRA=1:tp=-1:linear=false:dual_mono=true', '--no-video', '--idle', '--volume=50', '--input-ipc-server=' + runtime_dir + '/radioweb-mpv.socket', '--demuxer-readahead-secs=60'],
	{
	  detached: true,
	  stdio: "ignore"
	}).unref()
